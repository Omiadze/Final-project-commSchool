...
const jewelryItemsDiv = document.getElementById("jewelry-items-div");
showJewelryItems(savedItems);

function showJewelryItems(savedItems) {
  console.log(savedItems);
  savedItems.forEach((savedItem) => {
    if (savedItem.category === "jewelery") {
      ...
      jewelryItemsDiv.appendChild(itemDiv);
    }
  });
}
