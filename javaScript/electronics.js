...
const electronicsItemsDiv = document.getElementById("electronics-items-div");
showElectronicsItems(savedItems);

function showElectronicsItems(savedItems) {
  console.log(savedItems);
  savedItems.forEach((savedItem) => {
    if (savedItem.category === "electronics") {
      ...
      electronicsItemsDiv.appendChild(itemDiv);
    }
  });
}
